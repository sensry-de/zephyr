 ...
 */
static int32_t sy1xx_spi_write(const struct device *dev, sy1xx_spiTransfer_t *request)
{
 ...
 */
int32_t sy1xx_spi_read(const struct device *dev, sy1xx_spiTransfer_t *request)
{
